...
/* compiled from: LaderShipArrayResponse.kt */
...
public final class LaderShipArrayResponse {
    ...
    public static /* synthetic */ LaderShipArrayResponse copy$default(LaderShipArrayResponse laderShipArrayResponse, String str, String str2, int i, String str3, String str4, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            str = laderShipArrayResponse.referUserId;
        }
        if ((i3 & 2) != 0) {
            str2 = laderShipArrayResponse.referName;
        }
        String str5 = str2;
        if ((i3 & 4) != 0) {
            i = laderShipArrayResponse.referCount;
        }
        int i4 = i;
        if ((i3 & 8) != 0) {
            str3 = laderShipArrayResponse.regesiteredDate;
        }
        String str6 = str3;
        if ((i3 & 16) != 0) {
            str4 = laderShipArrayResponse.referAlliasName;
        }
        String str7 = str4;
        if ((i3 & 32) != 0) {
            i2 = laderShipArrayResponse.referRank;
        }
        return laderShipArrayResponse.copy(str, str5, i4, str6, str7, i2);
    }
    ...
    public final LaderShipArrayResponse copy(String str, String str2, int i, String str3, String str4, int i2) {
        return new LaderShipArrayResponse(str, str2, i, str3, str4, i2);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LaderShipArrayResponse) {
            LaderShipArrayResponse laderShipArrayResponse = (LaderShipArrayResponse) obj;
            return Intrinsics.areEqual(this.referUserId, laderShipArrayResponse.referUserId) && Intrinsics.areEqual(this.referName, laderShipArrayResponse.referName) && this.referCount == laderShipArrayResponse.referCount && Intrinsics.areEqual(this.regesiteredDate, laderShipArrayResponse.regesiteredDate) && Intrinsics.areEqual(this.referAlliasName, laderShipArrayResponse.referAlliasName) && this.referRank == laderShipArrayResponse.referRank;
        }
        return false;
    }
    ...
    public String toString() {
        return "LaderShipArrayResponse(referUserId=" + this.referUserId + ", referName=" + this.referName + ", referCount=" + this.referCount + ", regesiteredDate=" + this.regesiteredDate + ", referAlliasName=" + this.referAlliasName + ", referRank=" + this.referRank + ')';
    }

    public LaderShipArrayResponse(String str, String str2, int i, String str3, String str4, int i2) {
    ...
    public /* synthetic */ LaderShipArrayResponse(String str, String str2, int i, String str3, String str4, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {

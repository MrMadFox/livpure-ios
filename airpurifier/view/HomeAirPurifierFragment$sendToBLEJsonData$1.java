...
@DebugMetadata(c = "com.livpure.safedrink.airpurifier.view.HomeAirPurifierFragment$sendToBLEJsonData$1", f = "HomeAirPurifierFragment.kt", i = {}, l = {1318}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class HomeAirPurifierFragment$sendToBLEJsonData$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ HomeAirPurifierFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HomeAirPurifierFragment$sendToBLEJsonData$1(HomeAirPurifierFragment homeAirPurifierFragment, Continuation<? super HomeAirPurifierFragment$sendToBLEJsonData$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new HomeAirPurifierFragment$sendToBLEJsonData$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((HomeAirPurifierFragment$sendToBLEJsonData$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

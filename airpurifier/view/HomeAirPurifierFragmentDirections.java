...
public class HomeAirPurifierFragmentDirections {
    private HomeAirPurifierFragmentDirections() {
    }

    public static ActionHomeAirPurifierFragmentToBoltSettingsFragment actionHomeAirPurifierFragmentToBoltSettingsFragment(DeviceList device) {
        return new ActionHomeAirPurifierFragmentToBoltSettingsFragment(device);
    }

    public static ActionHomeFragmentToAddLitresFagment actionHomeFragmentToAddLitresFagment(DeviceList device) {
        return new ActionHomeFragmentToAddLitresFagment(device);
    }
    ...
    /* loaded from: classes3.dex */
    public static class ActionHomeAirPurifierFragmentToBoltSettingsFragment implements NavDirections {
        private final HashMap arguments;

        @Override // androidx.navigation.NavDirections
        public int getActionId() {
            return R.id.action_homeAirPurifierFragment_to_BoltSettingsFragment;
        }

        private ActionHomeAirPurifierFragmentToBoltSettingsFragment(DeviceList device) {
        ...
        public ActionHomeAirPurifierFragmentToBoltSettingsFragment setDevice(DeviceList device) {
            if (device == null) {
                throw new IllegalArgumentException("Argument \"device\" is marked as non-null but was passed a null value.");
            }
        ...
        public boolean equals(Object object) {
            ...
            ActionHomeAirPurifierFragmentToBoltSettingsFragment actionHomeAirPurifierFragmentToBoltSettingsFragment = (ActionHomeAirPurifierFragmentToBoltSettingsFragment) object;
            if (this.arguments.containsKey(AndroidContextPlugin.DEVICE_KEY) != actionHomeAirPurifierFragmentToBoltSettingsFragment.arguments.containsKey(AndroidContextPlugin.DEVICE_KEY)) {
                return false;
            }
            if (getDevice() == null ? actionHomeAirPurifierFragmentToBoltSettingsFragment.getDevice() == null : getDevice().equals(actionHomeAirPurifierFragmentToBoltSettingsFragment.getDevice())) {
                return getActionId() == actionHomeAirPurifierFragmentToBoltSettingsFragment.getActionId();
            }
            return false;
        }
        ...
        public String toString() {
            return "ActionHomeAirPurifierFragmentToBoltSettingsFragment(actionId=" + getActionId() + "){device=" + getDevice() + "}";
        }
    }

    /* loaded from: classes3.dex */
    public static class ActionHomeFragmentToAddLitresFagment implements NavDirections {
        private final HashMap arguments;

        @Override // androidx.navigation.NavDirections
        public int getActionId() {
            return R.id.action_homeFragment_to_addLitresFagment;
        }

        private ActionHomeFragmentToAddLitresFagment(DeviceList device) {
            HashMap hashMap = new HashMap();
            this.arguments = hashMap;
            if (device == null) {
                throw new IllegalArgumentException("Argument \"device\" is marked as non-null but was passed a null value.");
        ...
        public ActionHomeFragmentToAddLitresFagment setDevice(DeviceList device) {
            if (device == null) {
                throw new IllegalArgumentException("Argument \"device\" is marked as non-null but was passed a null value.");
            }
            this.arguments.put(AndroidContextPlugin.DEVICE_KEY, device);
        ...
        public boolean equals(Object object) {
            ...
            ActionHomeFragmentToAddLitresFagment actionHomeFragmentToAddLitresFagment = (ActionHomeFragmentToAddLitresFagment) object;
            if (this.arguments.containsKey(AndroidContextPlugin.DEVICE_KEY) != actionHomeFragmentToAddLitresFagment.arguments.containsKey(AndroidContextPlugin.DEVICE_KEY)) {
                return false;
            }
            if (getDevice() == null ? actionHomeFragmentToAddLitresFagment.getDevice() == null : getDevice().equals(actionHomeFragmentToAddLitresFagment.getDevice())) {
                return getActionId() == actionHomeFragmentToAddLitresFagment.getActionId();
            }
            return false;
        }
        ...
        public String toString() {
            return "ActionHomeFragmentToAddLitresFagment(actionId=" + getActionId() + "){device=" + getDevice() + "}";
        }
    }

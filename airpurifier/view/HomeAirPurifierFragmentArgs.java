...
public class HomeAirPurifierFragmentArgs implements NavArgs {
    private final HashMap arguments;

    private HomeAirPurifierFragmentArgs() {
        this.arguments = new HashMap();
    }

    private HomeAirPurifierFragmentArgs(HashMap argumentsMap) {
        HashMap hashMap = new HashMap();
        this.arguments = hashMap;
        hashMap.putAll(argumentsMap);
    }

    public static HomeAirPurifierFragmentArgs fromBundle(Bundle bundle) {
        HomeAirPurifierFragmentArgs homeAirPurifierFragmentArgs = new HomeAirPurifierFragmentArgs();
        bundle.setClassLoader(HomeAirPurifierFragmentArgs.class.getClassLoader());
        if (bundle.containsKey(AndroidContextPlugin.DEVICE_KEY)) {
            if (Parcelable.class.isAssignableFrom(DeviceList.class) || Serializable.class.isAssignableFrom(DeviceList.class)) {
                ...
                homeAirPurifierFragmentArgs.arguments.put(AndroidContextPlugin.DEVICE_KEY, deviceList);
                return homeAirPurifierFragmentArgs;
            }
    ...
    public static HomeAirPurifierFragmentArgs fromSavedStateHandle(SavedStateHandle savedStateHandle) {
        HomeAirPurifierFragmentArgs homeAirPurifierFragmentArgs = new HomeAirPurifierFragmentArgs();
    ...
    public boolean equals(Object object) {
        ...
        HomeAirPurifierFragmentArgs homeAirPurifierFragmentArgs = (HomeAirPurifierFragmentArgs) object;
        if (this.arguments.containsKey(AndroidContextPlugin.DEVICE_KEY) != homeAirPurifierFragmentArgs.arguments.containsKey(AndroidContextPlugin.DEVICE_KEY)) {
            return false;
        }
        return getDevice() == null ? homeAirPurifierFragmentArgs.getDevice() == null : getDevice().equals(homeAirPurifierFragmentArgs.getDevice());
    }
    ...
    public String toString() {
        return "HomeAirPurifierFragmentArgs{device=" + getDevice() + "}";
    }
    ...
    public static final class Builder {
        ...
        public Builder(HomeAirPurifierFragmentArgs original) {
            HashMap hashMap = new HashMap();
            this.arguments = hashMap;
        ...
        public HomeAirPurifierFragmentArgs build() {
            return new HomeAirPurifierFragmentArgs(this.arguments);
        }

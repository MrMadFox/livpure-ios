...
@DebugMetadata(c = "com.livpure.safedrink.dispenser.view.UnlimitedWaterHomeFragment$sendToBLEJsonData$1", f = "UnlimitedWaterHomeFragment.kt", i = {}, l = {1221}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class UnlimitedWaterHomeFragment$sendToBLEJsonData$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ UnlimitedWaterHomeFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UnlimitedWaterHomeFragment$sendToBLEJsonData$1(UnlimitedWaterHomeFragment unlimitedWaterHomeFragment, Continuation<? super UnlimitedWaterHomeFragment$sendToBLEJsonData$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new UnlimitedWaterHomeFragment$sendToBLEJsonData$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((UnlimitedWaterHomeFragment$sendToBLEJsonData$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

...
@DebugMetadata(c = "com.livpure.safedrink.dispenser.view.HomeDispenserFragment$CommandPublish$1", f = "HomeDispenserFragment.kt", i = {}, l = {522}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class HomeDispenserFragment$CommandPublish$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ HomeDispenserFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HomeDispenserFragment$CommandPublish$1(HomeDispenserFragment homeDispenserFragment, Continuation<? super HomeDispenserFragment$CommandPublish$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new HomeDispenserFragment$CommandPublish$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((HomeDispenserFragment$CommandPublish$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

...
public class SelectPlanChangeFragmentDirections {
    private SelectPlanChangeFragmentDirections() {
    }

    public static ActionSelectPlanChargeFragmentToPlanDurationFragment actionSelectPlanChargeFragmentToPlanDurationFragment(PlansItem plan, DeviceList device) {
        return new ActionSelectPlanChargeFragmentToPlanDurationFragment(plan, device);
    }

    public static ActionSelectPlanOrRechargeFragmentToReviewOrderFragment actionSelectPlanOrRechargeFragmentToReviewOrderFragment(PriceItem plan, DeviceList device, String planName, String planNumber) {
        return new ActionSelectPlanOrRechargeFragmentToReviewOrderFragment(plan, device, planName, planNumber);
    }
    ...
    /* loaded from: classes3.dex */
    public static class ActionSelectPlanChargeFragmentToPlanDurationFragment implements NavDirections {
        private final HashMap arguments;

        @Override // androidx.navigation.NavDirections
        public int getActionId() {
            return R.id.action_selectPlanChargeFragment_to_planDurationFragment;
        }

        private ActionSelectPlanChargeFragmentToPlanDurationFragment(PlansItem plan, DeviceList device) {
        ...
        public ActionSelectPlanChargeFragmentToPlanDurationFragment setPlan(PlansItem plan) {
            if (plan == null) {
                throw new IllegalArgumentException("Argument \"plan\" is marked as non-null but was passed a null value.");
            }
        ...
        public ActionSelectPlanChargeFragmentToPlanDurationFragment setDevice(DeviceList device) {
            if (device == null) {
                throw new IllegalArgumentException("Argument \"device\" is marked as non-null but was passed a null value.");
            }
        ...
        public boolean equals(Object object) {
            ...
            ActionSelectPlanChargeFragmentToPlanDurationFragment actionSelectPlanChargeFragmentToPlanDurationFragment = (ActionSelectPlanChargeFragmentToPlanDurationFragment) object;
            if (this.arguments.containsKey("plan") != actionSelectPlanChargeFragmentToPlanDurationFragment.arguments.containsKey("plan")) {
                return false;
            }
            if (getPlan() == null ? actionSelectPlanChargeFragmentToPlanDurationFragment.getPlan() == null : getPlan().equals(actionSelectPlanChargeFragmentToPlanDurationFragment.getPlan())) {
                if (this.arguments.containsKey(AndroidContextPlugin.DEVICE_KEY) != actionSelectPlanChargeFragmentToPlanDurationFragment.arguments.containsKey(AndroidContextPlugin.DEVICE_KEY)) {
                    return false;
                }
                if (getDevice() == null ? actionSelectPlanChargeFragmentToPlanDurationFragment.getDevice() == null : getDevice().equals(actionSelectPlanChargeFragmentToPlanDurationFragment.getDevice())) {
                    return getActionId() == actionSelectPlanChargeFragmentToPlanDurationFragment.getActionId();
                }
                return false;
            }
            return false;
        ...
        public String toString() {
            return "ActionSelectPlanChargeFragmentToPlanDurationFragment(actionId=" + getActionId() + "){plan=" + getPlan() + ", device=" + getDevice() + "}";
        }
    }

    /* loaded from: classes3.dex */
    public static class ActionSelectPlanOrRechargeFragmentToReviewOrderFragment implements NavDirections {
        private final HashMap arguments;

        @Override // androidx.navigation.NavDirections
        public int getActionId() {
            return R.id.action_selectPlanOrRechargeFragment_to_reviewOrderFragment;
        }

        private ActionSelectPlanOrRechargeFragmentToReviewOrderFragment(PriceItem plan, DeviceList device, String planName, String planNumber) {
            HashMap hashMap = new HashMap();
            this.arguments = hashMap;
            if (plan == null) {
                throw new IllegalArgumentException("Argument \"plan\" is marked as non-null but was passed a null value.");
        ...
        public ActionSelectPlanOrRechargeFragmentToReviewOrderFragment setPlan(PriceItem plan) {
            if (plan == null) {
                throw new IllegalArgumentException("Argument \"plan\" is marked as non-null but was passed a null value.");
            }
            this.arguments.put("plan", plan);
        ...
        public ActionSelectPlanOrRechargeFragmentToReviewOrderFragment setDevice(DeviceList device) {
            if (device == null) {
                throw new IllegalArgumentException("Argument \"device\" is marked as non-null but was passed a null value.");
            }
            this.arguments.put(AndroidContextPlugin.DEVICE_KEY, device);
        ...
        public ActionSelectPlanOrRechargeFragmentToReviewOrderFragment setPlanName(String planName) {
            if (planName == null) {
                throw new IllegalArgumentException("Argument \"planName\" is marked as non-null but was passed a null value.");
            }
        ...
        public ActionSelectPlanOrRechargeFragmentToReviewOrderFragment setPlanNumber(String planNumber) {
            if (planNumber == null) {
                throw new IllegalArgumentException("Argument \"planNumber\" is marked as non-null but was passed a null value.");
            }
        ...
        public boolean equals(Object object) {
            ...
            ActionSelectPlanOrRechargeFragmentToReviewOrderFragment actionSelectPlanOrRechargeFragmentToReviewOrderFragment = (ActionSelectPlanOrRechargeFragmentToReviewOrderFragment) object;
            if (this.arguments.containsKey("plan") != actionSelectPlanOrRechargeFragmentToReviewOrderFragment.arguments.containsKey("plan")) {
                return false;
            }
            if (getPlan() == null ? actionSelectPlanOrRechargeFragmentToReviewOrderFragment.getPlan() == null : getPlan().equals(actionSelectPlanOrRechargeFragmentToReviewOrderFragment.getPlan())) {
                if (this.arguments.containsKey(AndroidContextPlugin.DEVICE_KEY) != actionSelectPlanOrRechargeFragmentToReviewOrderFragment.arguments.containsKey(AndroidContextPlugin.DEVICE_KEY)) {
                    return false;
                }
                if (getDevice() == null ? actionSelectPlanOrRechargeFragmentToReviewOrderFragment.getDevice() == null : getDevice().equals(actionSelectPlanOrRechargeFragmentToReviewOrderFragment.getDevice())) {
                    if (this.arguments.containsKey("planName") != actionSelectPlanOrRechargeFragmentToReviewOrderFragment.arguments.containsKey("planName")) {
                        return false;
                    }
                    if (getPlanName() == null ? actionSelectPlanOrRechargeFragmentToReviewOrderFragment.getPlanName() == null : getPlanName().equals(actionSelectPlanOrRechargeFragmentToReviewOrderFragment.getPlanName())) {
                        if (this.arguments.containsKey("planNumber") != actionSelectPlanOrRechargeFragmentToReviewOrderFragment.arguments.containsKey("planNumber")) {
                            return false;
                        }
                        if (getPlanNumber() == null ? actionSelectPlanOrRechargeFragmentToReviewOrderFragment.getPlanNumber() == null : getPlanNumber().equals(actionSelectPlanOrRechargeFragmentToReviewOrderFragment.getPlanNumber())) {
                            return getActionId() == actionSelectPlanOrRechargeFragmentToReviewOrderFragment.getActionId();
                        }
                        return false;
                    }
                    return false;
        ...
        public String toString() {
            return "ActionSelectPlanOrRechargeFragmentToReviewOrderFragment(actionId=" + getActionId() + "){plan=" + getPlan() + ", device=" + getDevice() + ", planName=" + getPlanName() + ", planNumber=" + getPlanNumber() + "}";
        }
    }
}

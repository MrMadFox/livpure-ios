...
public class SelectPlanFragmentArgs implements NavArgs {
    private final HashMap arguments;

    private SelectPlanFragmentArgs() {
        this.arguments = new HashMap();
    }

    private SelectPlanFragmentArgs(HashMap argumentsMap) {
        HashMap hashMap = new HashMap();
        this.arguments = hashMap;
        hashMap.putAll(argumentsMap);
    }

    public static SelectPlanFragmentArgs fromBundle(Bundle bundle) {
        SelectPlanFragmentArgs selectPlanFragmentArgs = new SelectPlanFragmentArgs();
        bundle.setClassLoader(SelectPlanFragmentArgs.class.getClassLoader());
        if (bundle.containsKey(AndroidContextPlugin.DEVICE_KEY)) {
            if (Parcelable.class.isAssignableFrom(DeviceList.class) || Serializable.class.isAssignableFrom(DeviceList.class)) {
                ...
                selectPlanFragmentArgs.arguments.put(AndroidContextPlugin.DEVICE_KEY, deviceList);
                return selectPlanFragmentArgs;
            }
    ...
    public static SelectPlanFragmentArgs fromSavedStateHandle(SavedStateHandle savedStateHandle) {
        SelectPlanFragmentArgs selectPlanFragmentArgs = new SelectPlanFragmentArgs();
    ...
    public boolean equals(Object object) {
        ...
        SelectPlanFragmentArgs selectPlanFragmentArgs = (SelectPlanFragmentArgs) object;
        if (this.arguments.containsKey(AndroidContextPlugin.DEVICE_KEY) != selectPlanFragmentArgs.arguments.containsKey(AndroidContextPlugin.DEVICE_KEY)) {
            return false;
        }
        return getDevice() == null ? selectPlanFragmentArgs.getDevice() == null : getDevice().equals(selectPlanFragmentArgs.getDevice());
    }
    ...
    public String toString() {
        return "SelectPlanFragmentArgs{device=" + getDevice() + "}";
    }
    ...
    public static final class Builder {
        ...
        public Builder(SelectPlanFragmentArgs original) {
            HashMap hashMap = new HashMap();
            this.arguments = hashMap;
        ...
        public SelectPlanFragmentArgs build() {
            return new SelectPlanFragmentArgs(this.arguments);
        }

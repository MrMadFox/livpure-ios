...
public class PlanFragmentDirections {
    ...
    public static ActionPlanFragmentToReviewOrderFragment actionPlanFragmentToReviewOrderFragment(PriceItem plan, DeviceList device, String planName, String planNumber) {
        return new ActionPlanFragmentToReviewOrderFragment(plan, device, planName, planNumber);
    }
    ...
    /* loaded from: classes3.dex */
    public static class ActionPlanFragmentToReviewOrderFragment implements NavDirections {
        private final HashMap arguments;

        @Override // androidx.navigation.NavDirections
        public int getActionId() {
            return R.id.action_planFragment_to_reviewOrderFragment;
        }

        private ActionPlanFragmentToReviewOrderFragment(PriceItem plan, DeviceList device, String planName, String planNumber) {
        ...
        public ActionPlanFragmentToReviewOrderFragment setPlan(PriceItem plan) {
            if (plan == null) {
                throw new IllegalArgumentException("Argument \"plan\" is marked as non-null but was passed a null value.");
            }
        ...
        public ActionPlanFragmentToReviewOrderFragment setDevice(DeviceList device) {
            if (device == null) {
                throw new IllegalArgumentException("Argument \"device\" is marked as non-null but was passed a null value.");
            }
        ...
        public ActionPlanFragmentToReviewOrderFragment setPlanName(String planName) {
            if (planName == null) {
                throw new IllegalArgumentException("Argument \"planName\" is marked as non-null but was passed a null value.");
            }
        ...
        public ActionPlanFragmentToReviewOrderFragment setPlanNumber(String planNumber) {
            if (planNumber == null) {
                throw new IllegalArgumentException("Argument \"planNumber\" is marked as non-null but was passed a null value.");
            }
        ...
        public boolean equals(Object object) {
            ...
            ActionPlanFragmentToReviewOrderFragment actionPlanFragmentToReviewOrderFragment = (ActionPlanFragmentToReviewOrderFragment) object;
            if (this.arguments.containsKey("plan") != actionPlanFragmentToReviewOrderFragment.arguments.containsKey("plan")) {
                return false;
            }
            if (getPlan() == null ? actionPlanFragmentToReviewOrderFragment.getPlan() == null : getPlan().equals(actionPlanFragmentToReviewOrderFragment.getPlan())) {
                if (this.arguments.containsKey(AndroidContextPlugin.DEVICE_KEY) != actionPlanFragmentToReviewOrderFragment.arguments.containsKey(AndroidContextPlugin.DEVICE_KEY)) {
                    return false;
                }
                if (getDevice() == null ? actionPlanFragmentToReviewOrderFragment.getDevice() == null : getDevice().equals(actionPlanFragmentToReviewOrderFragment.getDevice())) {
                    if (this.arguments.containsKey("planName") != actionPlanFragmentToReviewOrderFragment.arguments.containsKey("planName")) {
                        return false;
                    }
                    if (getPlanName() == null ? actionPlanFragmentToReviewOrderFragment.getPlanName() == null : getPlanName().equals(actionPlanFragmentToReviewOrderFragment.getPlanName())) {
                        if (this.arguments.containsKey("planNumber") != actionPlanFragmentToReviewOrderFragment.arguments.containsKey("planNumber")) {
                            return false;
                        }
                        if (getPlanNumber() == null ? actionPlanFragmentToReviewOrderFragment.getPlanNumber() == null : getPlanNumber().equals(actionPlanFragmentToReviewOrderFragment.getPlanNumber())) {
                            return getActionId() == actionPlanFragmentToReviewOrderFragment.getActionId();
                        }
                        return false;
                    }
                    return false;
        ...
        public String toString() {
            return "ActionPlanFragmentToReviewOrderFragment(actionId=" + getActionId() + "){plan=" + getPlan() + ", device=" + getDevice() + ", planName=" + getPlanName() + ", planNumber=" + getPlanNumber() + "}";
        }
    }
}

...
public class CancelSubsciptionFragmentDirections {
    private CancelSubsciptionFragmentDirections() {
    }

    public static NavDirections cancelSubscriptionConfirm() {
        return new ActionOnlyNavDirections(R.id.cancelSubscriptionConfirm);
    }

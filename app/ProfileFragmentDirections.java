...
public class ProfileFragmentDirections {
    ...
    public static NavDirections actionCancelSubscription() {
        return new ActionOnlyNavDirections(R.id.action_cancel_subscription);
    }

    public static NavDirections actionEmailMobileVerify() {
        return new ActionOnlyNavDirections(R.id.action_email_mobile_verify);
    }

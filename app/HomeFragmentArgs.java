...
public class HomeFragmentArgs implements NavArgs {
    ...
    public static HomeFragmentArgs fromBundle(Bundle bundle) {
        ...
        if (bundle.containsKey(AndroidContextPlugin.DEVICE_KEY)) {
            if (Parcelable.class.isAssignableFrom(DeviceList.class) || Serializable.class.isAssignableFrom(DeviceList.class)) {
                ...
                homeFragmentArgs.arguments.put(AndroidContextPlugin.DEVICE_KEY, deviceList);
    ...
    public boolean equals(Object object) {
        ...
        HomeFragmentArgs homeFragmentArgs = (HomeFragmentArgs) object;
        if (this.arguments.containsKey(AndroidContextPlugin.DEVICE_KEY) != homeFragmentArgs.arguments.containsKey(AndroidContextPlugin.DEVICE_KEY)) {
            return false;
        }
        return getDevice() == null ? homeFragmentArgs.getDevice() == null : getDevice().equals(homeFragmentArgs.getDevice());
    }
    ...
    public String toString() {
        return "HomeFragmentArgs{device=" + getDevice() + "}";
    }

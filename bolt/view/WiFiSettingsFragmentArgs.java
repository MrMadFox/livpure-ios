...
public class WiFiSettingsFragmentArgs implements NavArgs {
    private final HashMap arguments;

    private WiFiSettingsFragmentArgs() {
        this.arguments = new HashMap();
    }

    private WiFiSettingsFragmentArgs(HashMap argumentsMap) {
        HashMap hashMap = new HashMap();
        this.arguments = hashMap;
        hashMap.putAll(argumentsMap);
    }

    public static WiFiSettingsFragmentArgs fromBundle(Bundle bundle) {
        WiFiSettingsFragmentArgs wiFiSettingsFragmentArgs = new WiFiSettingsFragmentArgs();
        bundle.setClassLoader(WiFiSettingsFragmentArgs.class.getClassLoader());
        if (bundle.containsKey(AndroidContextPlugin.DEVICE_KEY)) {
            if (Parcelable.class.isAssignableFrom(DeviceList.class) || Serializable.class.isAssignableFrom(DeviceList.class)) {
                ...
                wiFiSettingsFragmentArgs.arguments.put(AndroidContextPlugin.DEVICE_KEY, deviceList);
                return wiFiSettingsFragmentArgs;
            }
    ...
    public static WiFiSettingsFragmentArgs fromSavedStateHandle(SavedStateHandle savedStateHandle) {
        WiFiSettingsFragmentArgs wiFiSettingsFragmentArgs = new WiFiSettingsFragmentArgs();
    ...
    public boolean equals(Object object) {
        ...
        WiFiSettingsFragmentArgs wiFiSettingsFragmentArgs = (WiFiSettingsFragmentArgs) object;
        if (this.arguments.containsKey(AndroidContextPlugin.DEVICE_KEY) != wiFiSettingsFragmentArgs.arguments.containsKey(AndroidContextPlugin.DEVICE_KEY)) {
            return false;
        }
        return getDevice() == null ? wiFiSettingsFragmentArgs.getDevice() == null : getDevice().equals(wiFiSettingsFragmentArgs.getDevice());
    }
    ...
    public String toString() {
        return "WiFiSettingsFragmentArgs{device=" + getDevice() + "}";
    }
    ...
    public static final class Builder {
        ...
        public Builder(WiFiSettingsFragmentArgs original) {
            HashMap hashMap = new HashMap();
            this.arguments = hashMap;
        ...
        public WiFiSettingsFragmentArgs build() {
            return new WiFiSettingsFragmentArgs(this.arguments);
        }

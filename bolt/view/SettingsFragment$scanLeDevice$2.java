...
@DebugMetadata(c = "com.livpure.safedrink.bolt.view.SettingsFragment$scanLeDevice$2", f = "SettingsFragment.kt", i = {}, l = {366}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class SettingsFragment$scanLeDevice$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ SettingsFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SettingsFragment$scanLeDevice$2(SettingsFragment settingsFragment, Continuation<? super SettingsFragment$scanLeDevice$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SettingsFragment$scanLeDevice$2(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((SettingsFragment$scanLeDevice$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

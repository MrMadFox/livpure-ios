...
@DebugMetadata(c = "com.livpure.safedrink.bolt.view.WiFiSettingsFragment$scanLeDevice$1", f = "WiFiSettingsFragment.kt", i = {}, l = {335}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class WiFiSettingsFragment$scanLeDevice$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ WiFiSettingsFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WiFiSettingsFragment$scanLeDevice$1(WiFiSettingsFragment wiFiSettingsFragment, Continuation<? super WiFiSettingsFragment$scanLeDevice$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new WiFiSettingsFragment$scanLeDevice$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((WiFiSettingsFragment$scanLeDevice$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (bluetoothLeScanner != null) {
            bluetoothAdapter = this.this$0.mBluetoothAdapterWiFi;
        ...
        if (!z) {
            try {
                ...
                wiFiSettingsModel = this.this$0.getWiFiSettingsModel();
                if (Intrinsics.areEqual(wiFiSettingsModel.getProductType(), "air-purifier")) {

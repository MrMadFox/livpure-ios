...
@DebugMetadata(c = "com.livpure.safedrink.bolt.view.SettingsFragment$displayData$5", f = "SettingsFragment.kt", i = {}, l = {707, 714}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class SettingsFragment$displayData$5 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ SettingsFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SettingsFragment$displayData$5(SettingsFragment settingsFragment, Continuation<? super SettingsFragment$displayData$5> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SettingsFragment$displayData$5(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((SettingsFragment$displayData$5) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

...
public class KycUploadFragmentDirections {
    private KycUploadFragmentDirections() {
    }

    public static NavDirections actionUploadKycToTrackRelocation() {
        return new ActionOnlyNavDirections(R.id.action_uploadKyc_to_trackRelocation);
    }

...
public class RelocationFragmentDirections {
    private RelocationFragmentDirections() {
    }

    public static NavDirections actionUpdateAddressToKycUpload() {
        return new ActionOnlyNavDirections(R.id.action_updateAddress_to_kycUpload);
    }
